        ...
        <div class="bottom-header bg-white shadow-[0px_1px_0px_#E1E3E6] relative z-30 hidden lg:block">
            <div class="container px-3 md:px-5 xl:px-0">
                <div class="py-3.5 flex justify-between items-center">
                    ...
                    <div>
                        <a href="shopping-cart.php" class="btn-primary">
                            <span>View Cart</span>
                            <span><svg width="0" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                </svg>
                            </span>
                        </a>
    ...
    <div class="breadcrumb">
        <div class="container px-3 md:px-5 xl:px-0">
            <div class="flex items-center gap-1 py-[1.5px]">
                ...
                <a href="BuyNowList.php" class="text-[14px] font-normal leading-[110%] text-dark-gray">Buy Now
                    Products</a>
                <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M7.125 5.25L10.875 9L7.125 12.75" stroke="#636270" stroke-linecap="round"
                        stroke-linejoin="round" />
                ...
                <div class="right-side xl:px-8 px-0 xl:w-5/12 w-full">
                    ...
                    <div class="flex items-center gap-2.5 mb-6">
                        <p class="flex gap-1.5 items-center">
                            <span class="text-[#272343] text-2xl">Price: Rs. <?php echo $row["Price"]; ?></span>
                        </p>
                    </div>
                    <div class="mb-6">
                        <ul class="p-0 m-0">
                    ...
                    <!-- <div class="flex flex-col gap-3">
                        ...
                        <div
                            ...
                            <input type="text" id="quantityInput"
                                class="text-[#272343] text-base plus_mines_input select-none" value="01" />
                            <span
                        ...
                        <div class="xl:w-[343px] add-to-cart-btn">
                            <form method="post" action="add_to_oders.php">
                                <input type="hidden" name="userName"
                                    value="<?php echo $firstName; ?> <?php echo $lastName; ?>">
                                <input type="hidden" name="productId" value="<?php echo $row['productId']; ?>">
                                <input type="hidden" name="quantity" id="selectedQuantity" value="5">
                                Replace with the selected quantity
                                <button type="submit"
                                    class="inline-flex gap-3 py-3.5 bg-[#029FAE] hover:bg-[#272343] transition-all duration-300 rounded-lg px-4 xl:w-[343px] w-full items-center justify-center">
                                    <span class="text-white text-base">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    ...
                                    <span class="text-white text-base">Buy Now</span>
                                </button>
                            </form>
                        </div>
                    </div> -->
                    ...
                    <div class="flex flex-col gap-3">
                        <div
                            ...
                            <input type="text" id="quantityInput" name="quantity"
                                class="text-[#272343] text-base plus_mines_input select-none" value="1" readonly />
                            <span
                                class="w-5 h-5 inline-flex justify-center items-center text-[#9A9CAA] pr-[14px] select-none plus"
                                id="plus">+</span>
                        </div>
                        <div class="flex gap-3 w-full">
                            <div class="xl:w-[343px] add-to-cart-btn">
                                <form method="post" action="add_to_cart.php">
                                    ...
                                    <input type="hidden" name="photoUrl" value="<?php echo $row['photoUrl']; ?>">
                                    <input type="text" name="quantity" id="selectedQuantity" value="1"
                                        style="display: none;">
                                    <button type="submit"
                                        class="inline-flex gap-3 py-3.5 bg-[#029FAE] hover:bg-[#272343] transition-all duration-300 rounded-lg px-4 xl:w-[343px] w-full items-center justify-center">
                                        <span class="text-white text-base">
...
?>
                    ...
                    <div class="container px-3 md:px-5 xl:px-0">
                        <div class=" flex flex-wrap gap-y-6 justify-between">
                            <div class="footer-widget max-w-[350px]">
                                ...
                                <p class="lg:mb-6 mb-4 text-gray-black text-base">At Farm2Market, we cultivate
                                    connections
                                    between farmers and buyers, ensuring fresh harvests reach your table with
                                    transparency
                                    and trust.</p>
                                <ul class="flex gap-1">
                                    <li>
        ...
        minusButton.addEventListener('click', function() {
            ...
            if (currentValue > 1) {
                ...
                quantityInput.value = currentValue < 10 ? '0' + currentValue : currentValue;
            }
        });
