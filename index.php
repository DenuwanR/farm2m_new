...
<body class="font-display">
                        ...
                        <div>
                            <ul class="flex gap-6 items-center">
                                <li class="inline-flex items-center justify-center">
                                    ...
                                    <div>
                                        <p class="text-grayscales-900 inline-flex gap-2 items-center text-sm font-display" style="color: white;">
        ...
        <div class="bottom-header bg-white shadow-[0px_1px_0px_#E1E3E6] relative z-30 hidden lg:block">
            <div class="container px-3 md:px-5 xl:px-0">
                <div class="py-3.5 flex justify-between items-center">
                    ...
                    <div>
                        <a href="addProducts.php" class="btn-primary">
                            <span>Add Your Product</span>
                            <span><svg width="0" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                </svg>
                            </span>
                        </a>
                    </div>
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="container px-3 md:px-5 flex flex-col md:flex-row items-center">
                        <div class="md:w-1/2 w-full">
                            <p class="text-gray-black text-sm tracking-[0.12em] mb-2">Welcome to the Agricultural Revolution</p>
                            <h1 class="xl:text-[68px] text-xl md:text-3xl xl:leading-[110%] text-gray-black font-semibold mb-6">Freshness Unleashed.. <br> Bid, Buy, Enjoy!</h1>
                            <div>
                        ...
                        <div class="md:w-1/2 w-full flex justify-center items-center relative">
                            <img src="./src/images/veg.png" alt="">
                ...
                <div class="swiper-slide">
                    <div class="container px-3 md:px-5 flex flex-col md:flex-row items-center">
                        <div class="md:w-1/2 w-full">
                            <p class="text-gray-black text-sm tracking-[0.12em] mb-2">Welcome to the Agricultural Revolution</p>
                            <h1 class="xl:text-[68px] text-xl md:text-3xl xl:leading-[110%] text-gray-black font-semibold mb-6">Bid High, Eat Fresh! <br> Your Farm2Market Experience..</h1>
                            <div>
                ...
                <div class="swiper-slide">
                    <div class="container px-3 md:px-5 flex flex-col md:flex-row items-center">
                        <div class="md:w-1/2 w-full">
                            <p class="text-gray-black text-sm tracking-[0.12em] mb-2">Welcome to the Agricultural Revolution</p>
                            <h1 class="xl:text-[68px] text-xl md:text-3xl xl:leading-[110%] text-gray-black font-semibold mb-6">Nature's Best, Your Best! <br> Farm2Market's Bounty Awaits..</h1>
                            <div>
                                <a href="products.html" class="btn-primary">
                                    <span>Shop Now</span>
                                    <span><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="md:w-1/2 w-full flex justify-center items-center relative">
                            <img src="./src/images/veg2.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white shadow-[0px_24px_100px_rgba(22,25,50,0.07)] rounded-xl xl:py-[50px] xl:px-[70px] p-8 mb-[26px]">
                <div class="grid grid-cols-1 xl:grid-cols-4 sm:grid-cols-2 gap-6">
                    <div class="feature-card flex gap-4 items-center w-full max-w-[280px]">
                        ...
                        <div>
                            <h3 class="text-lg leading-[110%] text-gray-black mb-1.5 font-medium">Fresh Foods</h3>
                            <p class="text-[#9A9CAA] text-[15px] leading-[110%]">Fresh & Healthy Foods</p>
                        </div>
                    </div>
                    <div class="feature-card flex gap-4 items-center w-full max-w-[280px]">
                        <div>
                        ...
                        <div>
                            <h3 class="text-lg leading-[110%] text-gray-black mb-1.5 font-medium">Quick Delivery</h3>
                            <p class="text-[#9A9CAA] text-[15px] leading-[110%]">Within 48hrs to your Doorstep</p>
                        </div>
                    </div>
                    <div class="feature-card flex gap-4 items-center w-full max-w-[280px]">
                        <div>
                        ...
                        <div>
                            ...
                            <p class="text-[#9A9CAA] text-[15px] leading-[110%]">100% Secure Payment Methods</p>
                        </div>
                    </div>
                    <div class="feature-card flex gap-4 items-center w-full max-w-[280px]">
                        <div>
                        ...
                        <div>
                            <h3 class="text-lg leading-[110%] text-gray-black mb-1.5 font-medium">Customer Service 24/7</h3>
            ...
            <div class="swiper brandSwiper overflow-hidden">
                <div class="swiper-wrapper items-center">
                    <div class="swiper-slide inline-flex items-center justify-center">
                        <a href="#"><img src="./public/assets/images/all-img/payhere.png" alt=""></a>
                    </div>
                    <div class="swiper-slide inline-flex items-center justify-center">
                        <a href="#"><img src="./public/assets/images/all-img/visa.png" alt=""></a>
                    </div>
                    <div class="swiper-slide inline-flex items-center justify-center">
                        <a href="#"><img src="./public/assets/images/all-img/master.jpg" alt=""></a>
                    </div>
                    <div class="swiper-slide inline-flex items-center justify-center">
                        <a href="#"><img src="./public/assets/images/all-img/gpay.png" alt=""></a>
                    </div>
                    <div class="swiper-slide inline-flex items-center justify-center">
                        <a href="#"><img src="./public/assets/images/all-img/applepay.png" alt=""></a>
                    </div>
                    <div class="swiper-slide inline-flex items-center justify-center">
                        <a href="#"><img src="./public/assets/images/all-img/HELAPAY.png" alt=""></a>
                    </div>
                    <div class="swiper-slide inline-flex items-center justify-center">
                        <a href="#"><img src="./public/assets/images/all-img/paypal (2).png" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="swiper-wrapper">
                        ...
                        <div class="product-card">
                            <a href="AuctionList.php">
                                <div class="product-thumb">
                                    <img src="./public/assets/images/all-img/veg/Carrot-1-300x300.jpg" alt="">
                                    <span class="badge new">New</span>
                                </div>
                                <div class="product-info">
                                    <div>
                                        <h2 class="product-name">Carrots</h2>
                                        <h3 class="product-price">Rs.1800</h3>
                                    </div>
                                    <div>
                    ...
                    <div class="swiper-slide">
                        <div class="product-card">
                            <a href="AuctionList.php">
                                <div class="product-thumb">
                                    <img src="./public/assets/images/all-img/veg/Cabbage-1-300x300.jpg" alt="">
                                    <span class="badge new">New</span>
                                </div>
                                <div class="product-info">
                                    <div>
                                        <h2 class="product-name">Cabbage</h2>
                                        <h3 class="product-price">Rs.1200</h3>
                                    </div>
                                    <div>
                                        <button class="cart-icon">
                                            <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="swiper-slide">
                        <div class="product-card">
                            <a href="AuctionList.php">
                                <div class="product-thumb">
                                    <img src="./public/assets/images/all-img/veg/Beans-1.jpg" alt="">
                                    <span class="badge new">New</span>
                                </div>
                                <div class="product-info">
                                    <div>
                                        <h2 class="product-name">Beans</h2>
                                        <h3 class="product-price">Rs.1400</h3>
                                    </div>
                                    <div>
                                        <button class="cart-icon">
                                            <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="swiper-slide">
                        <div class="product-card">
                            <a href="product-details.html">
                                <div class="product-thumb">
                                    <img src="./public/assets/images/all-img/veg/Leeks-1-300x300.jpg" alt="">
                                    <span class="badge new">New</span>
                                </div>
                                <div class="product-info">
                                    <div>
                                        <h2 class="product-name">Leeks</h2>
                                        <h3 class="product-price">Rs.1200</h3>
                                    </div>
                                    <div>
                                        <button class="cart-icon">
                    ...
                    <div class="swiper-slide">
                        <div class="product-card">
                            <a href="BuyNowList.php">
                                <div class="product-thumb">
                                    <img src="./public/assets/images/all-img/veg/Brinjal-1-300x300.jpg" alt="">
                                    <span class="badge new">New</span>
                                </div>
                                <div class="product-info">
                                    <div>
                                        <h2 class="product-name">Brinjal</h2>
                                        <h3 class="product-price">Rs.800</h3>
                                    </div>
                                    <div>
                                        <button class="cart-icon">
                                            <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="swiper-slide">
                        <div class="product-card">
                            <a href="AuctionList.php">
                                <div class="product-thumb">
                                    <img src="./public/assets/images/all-img/veg/beetroot-300x300.jpg" alt="">
                                    <span class="badge new">New</span>
                                </div>
                                <div class="product-info">
                                    <div>
                                        <h2 class="product-name">Beetroots</h2>
                                        <h3 class="product-price">Rs.900</h3>
                                    </div>
                                    <div>
                                        <button class="cart-icon">
                                            <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="swiper-slide">
                        <div class="product-card">
                            <a href="BuyNowList.php">
                                <div class="product-thumb">
                                    <img src="./public/assets/images/all-img/veg/Ladies-Fingers-Okra-1-300x300.jpg" alt="">
                                    <span class="badge new">New</span>
                                </div>
                                <div class="product-info">
                                    <div>
                                        <h2 class="product-name">Ladies Fingers</h2>
                                        <h3 class="product-price">Rs.950</h3>
                                    </div>
                                    <div>
                                        <button class="cart-icon">
                                            <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="swiper-slide">
                        <div class="product-card">
                            <a href="BuyNowList.php">
                                <div class="product-thumb">
                                    <img src="./public/assets/images/all-img/veg/Cucumber-_JapaneseSalad-1-300x300.jpg" alt="">
                                    <span class="badge new">New</span>
                                </div>
                                <div class="product-info">
                                    <div>
                                        <h2 class="product-name">Cucumber</h2>
                                        <h3 class="product-price">Rs.600</h3>
                                    </div>
                                    <div>
                                        <button class="cart-icon">
                                            <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <section class="lg:py-20 sm:py-8 py-6" id="featured">
        <div class="container px-3 md:px-5 xl:px-0">
            ...
            <div id="portfoliolist" class="portfoliolist justify-center mx-auto">
                ...
                <div class="mix all best-sellers" data-cat="best-sellers">
                    <div class="product-card">
                        <a href="AuctionList.php">
                            <div class="product-thumb">
                                <img src="./public/assets/images/all-img/veg/Mushrooms-300x300.png" alt="">
                                <span class="badge new">New</span>
                            </div>
                            <div class="product-info">
                                <div>
                                    <h2 class="product-name">Mushroom</h2>
                                    <h3 class="product-price">Rs.2000</h3>
                                </div>
                                <div>
                                    <button class="cart-icon">
                                        <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="mix all trending" data-cat="trending">
                    <div class="product-card">
                        <a href="AuctionList.php">
                            <div class="product-thumb">
                                <img src="./public/assets/images/all-img/veg/avocado-300x300.jpg" alt="">
                                <span class="badge new">New</span>
                            </div>
                            <div class="product-info">
                                <div>
                                    <h2 class="product-name">Avacado</h2>
                                    <h3 class="product-price">Rs.950</h3>
                                </div>
                                <div>
                                    <button class="cart-icon">
                ...
                <div class="mix all trending" data-cat="trending">
                    <div class="product-card">
                        <a href="BuyNowList.php">
                            <div class="product-thumb">
                                <img src="./public/assets/images/all-img/veg/apple-1.jpg" alt="">
                                <span class="badge new">New</span>
                            </div>
                            <div class="product-info">
                                <div>
                                    <h2 class="product-name">Red Apple</h2>
                                    <h3 class="product-price">Rs.200</h3>
                                </div>
                                <div>
                                    <button class="cart-icon">
                                        <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="mix all best-sellers" data-cat="best-sellers">
                    <div class="product-card">
                        <a href="AuctionList.php">
                            <div class="product-thumb">
                                <img src="./public/assets/images/all-img/veg/orange.jpg" alt="">
                                <span class="badge new">New</span>
                            </div>
                            <div class="product-info">
                                <div>
                                    <h2 class="product-name">Orange</h2>
                                    <h3 class="product-price">Rs.250</h3>
                                </div>
                                <div>
                                    <button class="cart-icon">
                                        <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="mix all newest" data-cat="newest">
                    <div class="product-card">
                        <a href="AuctionList.php">
                            <div class="product-thumb">
                                <img src="./public/assets/images/all-img/veg/Pineapple-queen1-300x300.jpg" alt="">
                                <span class="badge new">New</span>
                            </div>
                            <div class="product-info">
                                <div>
                                    <h2 class="product-name">Pineapple</h2>
                                    <h3 class="product-price">Rs.830</h3>
                                </div>
                                <div>
                                    <button class="cart-icon">
                                        <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <section id="about" class="overflow-hidden lg:py-20 sm:py-8 py-5 bg-[#F0F2F3]">
        <div class="container px-3 md:px-5 xl:px-0">
            <div class="flex flex-wrap justify-between items-center mb-10">
                <h2 class="text-gray-black xl:text-[32px] xl:leading-[110%] text-xl md:text-2xl font-semibold font-display capitalize">What clients say about us</h2>
                <div class="flex gap-[18px]">
            ...
            <div class="swiper testimonialSwiper overflow-hidden">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        ...
                        <div class="testimonial-card bg-white lg:p-10 sm:p-6 p-4 rounded-xl shadow-[0px_8px_40px_rgba(39,35,67,0.08)]">
                            <div class="shadow-[inset_2px_0px_0px_#029FAE] pl-6">
                                <p class="text-[#636270] font-display font-normal lg:text-[20px] lg:leading-[150%] sm:text-base text-sm capitalize">“"As a farmer, Farm2Market has opened up new opportunities for me to reach customers and expand my business.“</p>
                            </div>
                            <div class="flex justify-between items-end">
                                <div class="flex items-center flex-wrap gap-3">
                                    <div class="lg:w-[60px] lg:h-[60px] sm:w-12 sm:h-12 w-8 h-8">
                                        <img src="./public/assets/images/all-img/supun-perera-gqA9S.jpeg" alt="" class="w-full h-full rounded-full">
                                    </div>
                                    <div>
                                        <h4 class="xl:text-[20px] xl:leading-[140%] text-sm md:text-base text-gray-black capitalize font-medium font-display">Supun Perera</h4>
                                        <p class="text-[#9A9CAA] lg:text-[16px] lg:leading-[140%] text-sm font-normal font-display">A young Farmer</p>
                                    </div>
                                </div>
                    ...
                    <div class="swiper-slide">
                        ...
                        <div class="testimonial-card bg-white lg:p-10 sm:p-6 p-4 rounded-xl shadow-[0px_8px_40px_rgba(39,35,67,0.08)]">
                            <div class="shadow-[inset_2px_0px_0px_#029FAE] pl-6">
                                <p class="text-[#636270] font-display font-normal lg:text-[20px] lg:leading-[150%] sm:text-base text-sm capitalize">“This is a good move to Sri Lankan Agriculture.A positive change for the business and people.Keep up the good work!!“</p>
                            </div>
                            <div class="flex justify-between items-end">
                                <div class="flex items-center flex-wrap gap-3">
                                    <div class="lg:w-[60px] lg:h-[60px] sm:w-12 sm:h-12 w-8 h-8">
                                        <img src="./public/assets/images/all-img/gathika.png" alt="" class="w-full h-full rounded-full">
                                    </div>
                                    <div>
                                        <h4 class="xl:text-[20px] xl:leading-[140%] text-sm md:text-base text-gray-black capitalize font-medium font-display">Gathika Colombage</h4>
                                        <p class="text-[#9A9CAA] lg:text-[16px] lg:leading-[140%] text-sm font-display">Software Engineer</p>
                                    </div>
                                </div>
                    ...
                    <div class=" flex flex-wrap gap-y-6 justify-between">
                        ...
                        <div class="footer-widget w-[424px]">
                            ...
                            <form action="https://api.web3forms.com/submit" method="POST">
                                ...
                                <p class="py-3 text-gray-black opacity-60">Reach out to us with your inquiries and
                                    feedback, <br> We're here to grow together..</p>
