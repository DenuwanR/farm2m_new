...
<body class="font-display">
    ...
    <div class="breadcrumb">
        <div class="container px-3 md:px-5 xl:px-0">
            <div class="flex items-center gap-1 py-[1.5px]">
                ...
                <span
                    class="text-[14px] font-medium leading-[110%] font-display text-gray-black inline-block">Auction Products</span>
            </div>
    ...
    <section class="">
        <div class="product-list-area shadow-[inset_0px_1px_0px_#E1E3E6]">
            <div class="container px-3 md:px-5 xl:px-0">
                <div class="products-wrapper py-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-6">
                    <?php
                    ...
                    $sql = "SELECT * FROM products WHERE sellCategory = 'Auction'";
                    $result = $conn->query($sql);

                    if ($result->num_rows > 0) {
                        // Output data of each row
                        while ($row = $result->fetch_assoc()) {
                            // Generate HTML code for each product card
                            ?>
                    <div class="product-card" id="product-card">
                        <a href="AuctionProductDetails.php?productId=<?php echo $row['productId']; ?>">
