                ...
                <div class="product-details-wrap pt-10">
                    ...
                    <div class="right-side xl:px-8 px-0 xl:w-5/12 w-full">
                        ...
                        <div class="flex gap-3 w-full">
                            <div class="xl:w-[343px] add-to-cart-btn">
                                <form method="post" action="add_to_cart.php">
                                    <input type="hidden" name="userName" value="<?php echo $firstName; ?> <?php echo $lastName; ?>">
                                    <input type="hidden" name="productId" value="<?php echo $row['productId']; ?>">
                                    <input type="hidden" name="quantity" value="7">
                                    <button type="submit" class="inline-flex gap-3 py-3.5 bg-[#029FAE] hover:bg-[#272343] transition-all duration-300 rounded-lg px-4 xl:w-[343px] w-full items-center justify-center">
                        ...
                        <form method="post" action="add_to_oders.php">
                            <input type="hidden" name="userName" value="<?php echo $firstName; ?> <?php echo $lastName; ?>">
                            <input type="hidden" name="productId" value="<?php echo $row['productId']; ?>">
                            <input type="hidden" name="quantity" id="selectedQuantity" value="5"> <!-- Replace with the selected quantity -->
                            <button type="submit" class="inline-flex gap-3 py-3.5 bg-[#029FAE] hover:bg-[#272343] transition-all duration-300 rounded-lg px-4 xl:w-[343px] w-full items-center justify-center">
                                    <span class="text-white text-base">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
...
<script>
    // Function to increase or decrease the selected quantity
    function updateQuantity(action) {
        let quantityInput = document.getElementById('selectedQuantity');
...
<!-- <script>
    $(document).ready(function() {
        var qntfinal = 0; // Initialize qntfinal with default value
        ...
        $('.minus').click(function() {
            ...
            $input.val(count);
            qntfinal = count; // Update qntfinal
            $input.change();
            return false;
        });
        ...
        $('.plus').click(function() {
            ...
            qntfinal = $input.val(); // Update qntfinal
            $input.change();
            return false;
        });
