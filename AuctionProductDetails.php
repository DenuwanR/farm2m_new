...
<body class="font-display">
    ...
    <div class="breadcrumb">
        <div class="container px-3 md:px-5 xl:px-0">
            <div class="flex items-center gap-1 py-[1.5px]">
                ...
                <a href="BuyNowList.php" class="text-[14px] font-normal leading-[110%] text-dark-gray">Auction
                    Products</a>
                <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M7.125 5.25L10.875 9L7.125 12.75" stroke="#636270" stroke-linecap="round"
                        stroke-linejoin="round" />
                </svg>
                <span class="text-[14px] font-medium leading-[110%] font-display text-gray-black inline-block">Product
                    Details</span>
            </div>
    ...
    <?php
        ...
        // Execute SELECT query to retrieve product details
            ...
            <div class="product-details-wrap pt-10">
                <div class="left-side xl:w-7/12 w-full">
                        ...
                        <div class="swiper-container gallery-main">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <img src="<?php echo $row["photoUrl"]; ?>" alt="<?php echo $row["productName"]; ?>">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="single-product-desc">
                        ...
                        <p class="text-[#636270] text-base mb-3"><?php echo $row["description"]; ?></p>
                    </div>
                </div>
                <div class="right-side xl:px-8 px-0 xl:w-5/12 w-full">
                    <h2 class="text-[#272343] pro-title font-semibold mb-3 capitalize">
                        <?php echo $row["productName"]; ?></h2>
                    <!-- <div class="flex items-center gap-2.5 mb-6">
                        <p class="flex gap-1.5 items-center">
                            <span class="text-[#272343] text-2xl">Starting Price: Rs.
                                <?php echo $row["Price"]; ?></span>
                        </p>
                    </div> -->
                    <div class="flex items-center gap-2.5 mb-6">
                        <p class="flex gap-1.5 items-center">
                            <span class="text-[#272343] text-2xl">Starting Price for the Stock: Rs.
                                <?php echo $row["Price"] * $row["quantity"] ?></span>
                        ...
                        <ul class="p-0 m-0">
                            <li>
                                <p class="text-[15px] inline-flex gap-2 items-center">
                                    <span class="text-[#9A9CAA]">Seller Name:</span><span
                                        class="text-[#636270] font-medium"><?php echo $row["sellerName"]; ?></span>
                                </p>
                            </li>
                            <li>
                                <p class="text-[15px] inline-flex gap-2 items-center">
                                    <span class="text-[#9A9CAA]">Category:</span><?php echo $row["category"]; ?><span
                                        class="text-[#636270] font-medium"></span>
                                </p>
                            </li>
                            <li>
                                <p class="text-[15px] inline-flex gap-2 items-center">
                                    <span class="text-[#9A9CAA]">Minimum Price for 1kg:</span><span
                                        class="text-[#636270] font-medium">Rs. <?php echo $row["Price"]; ?></span>
                                </p>
                            </li>
                            <li>
                                <p class="text-[15px] inline-flex gap-2 items-center">
                                    <span class="text-[#9A9CAA]">Quantity:</span><?php echo $row["quantity"]; ?><span
                                        class="text-[#636270] font-medium"></span>
                                </p>
                            </li>
                            <li>
                                <p class="text-[15px] inline-flex gap-2 items-center">
                                    <span class="text-[#9A9CAA]">Added
                                        Time:</span><?php echo $row["ProductTime"]; ?><span
                                        class="text-[#636270] font-medium"></span>
                                </p>
                            </li>
                            <li>
                                <p id="timer" class="text-[15px] inline-flex gap-2 items-center">
                                    <span class="text-[#9A9CAA]">Time Left:</span>
                                    <span id="countdown" class="text-[#636270] font-medium"></span>
                                </p>
                            </li>
                            <li>
                                <p class="text-[15px] inline-flex gap-2 items-center">
                                    <span class="text-[#9A9CAA]">Highest Bid for Now:</span>Rs.
                                    <?php echo $row["HighestBid"]; ?><span class="text-[#636270] font-medium"></span>
                                </p>
                            </li>
                        </ul>
                    </div>
                    <!-- Bid Button and Bid Value -->
                    <form method="POST" action="bidInsert.php?productId=<?php echo $productId; ?>">
                        <div class="flex flex-col gap-3">
                            <div class="xl:w-[284px] w-full">
                                <input type="number" id="HighestBid" name="HighestBid"
                                    placeholder="Enter Your Highest Bid Value"
                                    class="input-box focus:outline-none focus:ring-2 focus:ring-accents font-display transition duration-300 ease-in-out">
                            </div>
                            <button type="submit"
                                class="inline-flex gap-3 py-3.5 bg-[#029FAE] hover:bg-[#272343] transition-all duration-300 rounded-lg px-4 xl:w-[284px] w-full items-center justify-center">
                                <span class="text-white text-base">Place Bid</span>
                            </button>
                        </div>
                        <br>
                        <br>
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="product-card">
                            <a href="BuyNowList.php">
                                <div class="product-thumb">
                                    <img src="./public/assets/images/all-img/veg/Ladies-Fingers-Okra-1-300x300.jpg"
                                        alt="">
                                    <span class="badge new">New</span>
                                </div>
                                <div class="product-info">
                    ...
                    <div class="swiper-slide">
                        <div class="product-card">
                            <a href="BuyNowList.php">
                                <div class="product-thumb">
                                    <img src="./public/assets/images/all-img/veg/Cucumber-_JapaneseSalad-1-300x300.jpg"
                                        alt="">
                                    <span class="badge new">New</span>
                                </div>
                                <div class="product-info">
                ...
                <div class="container px-3 md:px-5 xl:px-0">
                    <div class=" flex flex-wrap gap-y-6 justify-between">
                        <div class="footer-widget max-w-[350px]">
                            ...
                            <p class="lg:mb-6 mb-4 text-gray-black text-base">At Farm2Market, we cultivate connections
                                between farmers and buyers, ensuring fresh harvests reach your table with transparency
                                and trust.</p>
                            <ul class="flex gap-1">
                                <li>
                                    <a href="#"
                        ...
                        <div class="footer-widget">
                            ...
                            <ul class="flex flex-col gap-3">
                                <li>
                                    <a href="#"
                                        class="footer-link text-gray-black text-base leading-[110%] hover:text-[#007580] transition-all duration-500 inline-block pb-1 ease-in-out">Vegetable</a>
                                </li>
                                <li>
                                    <a href="#"
                                        class="footer-link text-gray-black text-base leading-[110%] hover:text-[#007580] transition-all duration-500 inline-block pb-1">Fruits</a>
                                </li>
                                <li>
                                    <a href="#"
                                        class="footer-link text-gray-black text-base leading-[110%] hover:text-[#007580] transition-all duration-500 inline-block pb-1">Meats</a>
                                </li>
                                <li>
                                    <a href="#"
                                        class="footer-link text-gray-black text-base leading-[110%] hover:text-[#007580] transition-all duration-500 inline-block pb-1">Diary
                                        Products</a>
                                </li>
                                <li>
                                    <a href="#"
                                        class="footer-link text-gray-black text-base leading-[110%] hover:text-[#007580] transition-all duration-500 inline-block pb-1">Eggs</a>
                                </li>
                                <!-- <li>
            ...
            <div class="footer-bottom shadow-[inset_0px_1px_0px_#E1E3E6] py-6">
                <div class="container px-3 md:px-5 xl:px-0">
                    <div class="flex flex-wrap sm:justify-between sm:flex-nowrap justify-center items-center gap-y-6">
                        <p class="text-center text-[#9A9CAA]">&#169 All Rights Reserved <br> @2024 <b
                                class="text-grayscales-900">NIBM</b></p>
    ...
    <script>
    // Get the timestamp from PHP and convert it to JavaScript Date object
    var addedTime = new Date("<?php echo $row["ProductTime"]; ?>").getTime();

    // Set the countdown timer interval (1 second)
    var countdownInterval = setInterval(function() {
        // Get the current time
        var now = new Date().getTime();

        // Calculate the difference between current time and the added time
        var distance = addedTime + (72 * 60 * 60 * 1000) - now;
